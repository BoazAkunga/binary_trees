 ...
 * @root: Double ptr 2 the root node of the Heap 2 insert the value
 * @value: Value 2 store in the node 2 be inserted
 *
 * Return: Ptr 2 the created node
 *         NULL on failure
 */
...
heap_t *heap_insert(heap_t **root, int value)
{
	...
	/*
	 * Traverse tree 2 first empty slot based on the binary
 ...
 * @tree: Tree 2 measure the size of
 *
