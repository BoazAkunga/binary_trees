 ...
 * @tree: Ptr 2 the node 2 measure the depth of.
 *
 ...
 * @tree: Ptr 2 the root node of the tree 2 find a leaf in.
 *
 * Return: Ptr 2 the first encountered leaf.
 */
 ...
 * @tree: Ptr 2 the root node of the tree 2 check.
